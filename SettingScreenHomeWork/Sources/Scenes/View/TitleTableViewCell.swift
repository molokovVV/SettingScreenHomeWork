...
class TitleTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        iconImageView.frame = CGRect(x: (size - imageSize) / 20, 
                                     y: (size - imageSize) / 20, 
                                     width: imageSize, 
                                     height: imageSize)
        
        label.frame = CGRect(x: iconContainer.frame.size.width - 20, 
                             y: 0, 
    ...
    public func configure(with model: SectionTitleOption) {
